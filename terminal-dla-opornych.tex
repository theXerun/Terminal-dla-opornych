...
\dirtree{%
    .1 home.
        .2 user.
            .3 .bash\_history \dotfill \begin{minipage}[t]{0.5\textwidth}
                ...
                \vspace{\baselineskip}
            \end{minipage}.
            .3 .bashrc \dotfill \begin{minipage}[t]{0.5\textwidth}
                \textnormal{Plika zawierający skrypty, których zadaniem jest ustawianie wartości domyślnych podczas uruchamiania.}
                \vspace{\baselineskip}
            \end{minipage}.
            .3 .cache \dotfill \begin{minipage}[t]{0.5\textwidth}
                ...
                \vspace{\baselineskip}
            \end{minipage}.
            .3 .config \dotfill \begin{minipage}[t]{0.5\textwidth}
                \textnormal{W tym katalogu są pliki konfiguracyjne aplikacji dla danego użytkownika.}
                \vspace{\baselineskip}
            \end{minipage}.
            .3 .local \dotfill \begin{minipage}[t]{0.5\textwidth}
